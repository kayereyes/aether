...
<div class="container mx-auto space-y-8 py-8">
	<div class="space-y-2">
		...
		<p class="text-muted-foreground">
			A sliding panel component that overlays content from the edges of the viewport.
		</p>
	</div>
					...
					<SheetContent>
						...
						<div class="grid gap-4 py-4">
							...
							<div class="grid grid-cols-4 items-center gap-4">
								...
								<Input id="email" type="email" value="pedro@example.com" class="col-span-3" />
							</div>
							<div class="grid grid-cols-4 items-center gap-4">
								<Label for="bio" class="text-end">Bio</Label>
								<Textarea id="bio" class="col-span-3" rows={3} value="Software developer and designer." />
							</div>
						</div>
						<SheetFooter>
							<SheetClose>
						...
						<TabsContent value="account" class="space-y-4">
							...
							<div class="space-y-2">
								...
								<div class="flex items-center justify-between">
									<Label for="newsletter" class="text-sm font-normal">Newsletter</Label>
									<input type="checkbox" id="newsletter" checked />
								</div>
								<div class="flex items-center justify-between">
									<Label for="updates" class="text-sm font-normal">Product Updates</Label>
					...
					<div class="space-y-6 py-4">
						...
						<div class="space-y-2">
							...
							<div class="space-y-1 text-sm">
								...
								<p><span class="text-muted-foreground">Location:</span> San Francisco, CA</p>
							</div>
						</div>
						<div class="space-y-2">
			...
			<div class="space-y-4">
				...
				<Sheet bind:open={openControlled}>
					<SheetContent>
						...
						<div class="py-4">
							<p class="text-sm text-muted-foreground">
								You can open and close this sheet using the buttons outside, or use the close button here.
							</p>
						</div>
						<SheetFooter>
							<SheetClose>
