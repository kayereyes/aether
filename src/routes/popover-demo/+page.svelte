...
<div class="container mx-auto space-y-8 py-8">
	<div class="space-y-2">
		...
		<p class="text-muted-foreground">
			Comprehensive showcase of popover component with various styles, sizes, and animations.
		</p>
	</div>
				...
				<Popover>
					...
					>
						<div class="space-y-2">
							...
							<p class="text-sm">Ghost variant allows complete custom styling with gradients and colors.</p>
						</div>
					</PopoverContent>
				</Popover>
			</div>
				...
				<Popover>
					...
					<PopoverContent variant="minimal" size="auto" class="p-1 w-40">
						<div class="flex flex-col">
							...
							<button class="px-3 py-2 text-sm hover:bg-accent rounded text-left"
								>Duplicate</button
							>
							<button class="px-3 py-2 text-sm hover:bg-accent rounded text-left"
								>Archive</button
							...
							<button class="px-3 py-2 text-sm hover:bg-accent rounded text-left text-destructive"
								>Delete</button
							>
						</div>
					</PopoverContent>
		...
		<Card class="p-6">
			<div class="space-y-3">
				...
				<div class="flex items-center gap-2">
					...
					<Popover>
						<PopoverTrigger variant="default" class="rounded-full p-1 hover:bg-accent">
							<HelpCircle class="h-4 w-4 text-muted-foreground" />
						</PopoverTrigger>
						<PopoverContent size="sm" variant="minimal">
							<div class="space-y-2">
								<p class="text-sm font-medium">What are Advanced Settings?</p>
								<p class="text-sm text-muted-foreground">
									These settings allow you to customize advanced features and configurations that
			...
			<div class="space-y-3">
				...
				<div class="flex flex-wrap gap-4">
					<Popover>
						...
						<PopoverContent size="sm">
							<div class="space-y-2">
								<p class="font-medium text-sm">Schedule Meeting</p>
								<p class="text-sm text-muted-foreground">Select a date and time</p>
							</div>
						</PopoverContent>
					</Popover>
					...
					<Popover>
						...
						<PopoverContent size="sm">
							<div class="space-y-2">
								<p class="font-medium text-sm">3 New Notifications</p>
								<div class="space-y-1">
									<p class="text-xs text-muted-foreground">New message received</p>
									<p class="text-xs text-muted-foreground">Task assigned to you</p>
									<p class="text-xs text-muted-foreground">Meeting in 30 minutes</p>
								</div>
							</div>
						</PopoverContent>
					</Popover>
					...
					<Popover>
						...
						<PopoverContent size="sm">
							<div class="space-y-2">
								<p class="font-medium text-sm">Share this page</p>
								<div class="flex gap-2">
									<Button size="sm" variant="outline" class="flex-1">Copy Link</Button>
									<Button size="sm" variant="outline" class="flex-1">Email</Button>
								</div>
							</div>
						</PopoverContent>
					</Popover>
